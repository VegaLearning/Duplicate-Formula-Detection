...
IMAGE_PATH = '../images/imgs_noise/imgs_noise_0.05/'
RESULTS_PATH = './test_deep2ch_logs.txt'
PARAM_SAVE_PATH = './deep2ch_parameters/'
PRINT_STEP = 10
BATCH_SIZE = 64
Bias_deep2ch = -0.99
...
class deep_2ch(nn.Module):
    def __init__(self):
        ...
        self.stack_layer1 = stack_layer(96,96)
        self.stack_layer2 = stack_layer(96,192)
